...
function validateAndNormalizeEvent(event, source) {
  ...
  const normalizedEvent = {
    ...
    // Location
    venue: typeof event.venue === 'object' ? (event.venue?.name || 'Venue TBA') : (event.venue || 'Venue TBA'),
    address: typeof event.venue === 'object' ? (event.venue?.address || 'Address TBA') : (event.address || 'Address TBA'),
    city: typeof event.venue === 'object' ? (event.venue?.city || 'City TBA') : (event.city || 'City TBA'),
