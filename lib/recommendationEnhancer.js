...
class RecommendationEnhancer {
  ...
  return {
    ...
    // ========================================
    // SURGICAL ADDITION: NON-EDM GENRES
    // ========================================

    // Pop family (Low danceability/energy for EDM users)
    'pop': { energy: 0.65, danceability: 0.60, valence: 0.75, tempo: 115, acousticness: 0.15, instrumentalness: 0.05 },
    'pop rock': { energy: 0.70, danceability: 0.55, valence: 0.70, tempo: 120, acousticness: 0.12, instrumentalness: 0.10 },
    'indie pop': { energy: 0.60, danceability: 0.50, valence: 0.65, tempo: 110, acousticness: 0.20, instrumentalness: 0.15 },
    'synth pop': { energy: 0.65, danceability: 0.65, valence: 0.70, tempo: 115, acousticness: 0.08, instrumentalness: 0.25 },
    'dance pop': { energy: 0.75, danceability: 0.80, valence: 0.80, tempo: 125, acousticness: 0.05, instrumentalness: 0.20 },

    // Rock family (Low danceability, variable energy)
    'rock': { energy: 0.75, danceability: 0.45, valence: 0.55, tempo: 125, acousticness: 0.05, instrumentalness: 0.20 },
    'classic rock': { energy: 0.70, danceability: 0.40, valence: 0.60, tempo: 120, acousticness: 0.08, instrumentalness: 0.25 },
    'hard rock': { energy: 0.85, danceability: 0.40, valence: 0.50, tempo: 130, acousticness: 0.02, instrumentalness: 0.30 },
    'indie rock': { energy: 0.65, danceability: 0.45, valence: 0.55, tempo: 115, acousticness: 0.10, instrumentalness: 0.25 },
    'alternative rock': { energy: 0.70, danceability: 0.45, valence: 0.50, tempo: 120, acousticness: 0.08, instrumentalness: 0.30 },
    'punk rock': { energy: 0.90, danceability: 0.50, valence: 0.45, tempo: 150, acousticness: 0.02, instrumentalness: 0.15 },

    // Hip hop family (Moderate danceability, variable energy)
    'hip hop': { energy: 0.70, danceability: 0.75, valence: 0.55, tempo: 95, acousticness: 0.05, instrumentalness: 0.10 },
    'rap': { energy: 0.75, danceability: 0.70, valence: 0.50, tempo: 100, acousticness: 0.03, instrumentalness: 0.05 },
    'trap rap': { energy: 0.80, danceability: 0.80, valence: 0.45, tempo: 140, acousticness: 0.02, instrumentalness: 0.15 },

    // R&B/Soul family (Moderate characteristics)
    'r&b': { energy: 0.55, danceability: 0.70, valence: 0.65, tempo: 95, acousticness: 0.15, instrumentalness: 0.05 },
    'soul': { energy: 0.60, danceability: 0.65, valence: 0.70, tempo: 100, acousticness: 0.20, instrumentalness: 0.10 },
    'funk': { energy: 0.75, danceability: 0.85, valence: 0.75, tempo: 110, acousticness: 0.08, instrumentalness: 0.20 },

    // Jazz family (Low energy/danceability, high acousticness)
    'jazz': { energy: 0.40, danceability: 0.45, valence: 0.55, tempo: 120, acousticness: 0.60, instrumentalness: 0.70 },
    'smooth jazz': { energy: 0.30, danceability: 0.40, valence: 0.65, tempo: 100, acousticness: 0.70, instrumentalness: 0.75 },
    'swing': { energy: 0.60, danceability: 0.70, valence: 0.70, tempo: 130, acousticness: 0.50, instrumentalness: 0.60 },

    // Blues family (Low energy, moderate acousticness)
    'blues': { energy: 0.45, danceability: 0.40, valence: 0.35, tempo: 90, acousticness: 0.40, instrumentalness: 0.30 },
    'blues rock': { energy: 0.65, danceability: 0.50, valence: 0.45, tempo: 110, acousticness: 0.15, instrumentalness: 0.35 },

    // Country family (Moderate energy, high acousticness)
    'country': { energy: 0.55, danceability: 0.55, valence: 0.65, tempo: 110, acousticness: 0.45, instrumentalness: 0.20 },
    'country rock': { energy: 0.65, danceability: 0.50, valence: 0.60, tempo: 120, acousticness: 0.25, instrumentalness: 0.25 },
    'bluegrass': { energy: 0.60, danceability: 0.50, valence: 0.70, tempo: 130, acousticness: 0.80, instrumentalness: 0.60 },

    // Folk family (Low energy, high acousticness)
    'folk': { energy: 0.35, danceability: 0.35, valence: 0.55, tempo: 95, acousticness: 0.75, instrumentalness: 0.40 },
    'folk rock': { energy: 0.50, danceability: 0.40, valence: 0.60, tempo: 110, acousticness: 0.50, instrumentalness: 0.35 },
    'indie folk': { energy: 0.40, danceability: 0.35, valence: 0.50, tempo: 100, acousticness: 0.65, instrumentalness: 0.45 },

    // Classical family (Low energy/danceability, high acousticness/instrumentalness)
    'classical': { energy: 0.35, danceability: 0.20, valence: 0.50, tempo: 100, acousticness: 0.90, instrumentalness: 0.95 },
    'opera': { energy: 0.50, danceability: 0.15, valence: 0.55, tempo: 95, acousticness: 0.85, instrumentalness: 0.20 },

    // Reggae family (Moderate characteristics)
    'reggae': { energy: 0.50, danceability: 0.70, valence: 0.65, tempo: 90, acousticness: 0.25, instrumentalness: 0.30 },
    'dancehall': { energy: 0.70, danceability: 0.85, valence: 0.70, tempo: 100, acousticness: 0.10, instrumentalness: 0.20 },

    // World music family (Variable characteristics)
    'latin': { energy: 0.70, danceability: 0.80, valence: 0.75, tempo: 120, acousticness: 0.30, instrumentalness: 0.25 },
    'salsa': { energy: 0.80, danceability: 0.90, valence: 0.85, tempo: 180, acousticness: 0.25, instrumentalness: 0.30 },
    'bossa nova': { energy: 0.35, danceability: 0.50, valence: 0.70, tempo: 100, acousticness: 0.60, instrumentalness: 0.40 },

    // Metal family (High energy, low danceability)
    'metal': { energy: 0.90, danceability: 0.35, valence: 0.30, tempo: 140, acousticness: 0.01, instrumentalness: 0.40 },
    'heavy metal': { energy: 0.95, danceability: 0.30, valence: 0.25, tempo: 145, acousticness: 0.01, instrumentalness: 0.45 },

    // Punk family (High energy, low danceability)
    'punk': { energy: 0.90, danceability: 0.50, valence: 0.40, tempo: 160, acousticness: 0.02, instrumentalness: 0.15 },
    'pop punk': { energy: 0.80, danceability: 0.60, valence: 0.60, tempo: 150, acousticness: 0.05, instrumentalness: 0.10 },

    // Alternative family (Variable characteristics)
    'alternative': { energy: 0.65, danceability: 0.45, valence: 0.50, tempo: 115, acousticness: 0.15, instrumentalness: 0.25 },
    'grunge': { energy: 0.75, danceability: 0.40, valence: 0.35, tempo: 120, acousticness: 0.08, instrumentalness: 0.30 },
    'indie': { energy: 0.60, danceability: 0.45, valence: 0.55, tempo: 110, acousticness: 0.20, instrumentalness: 0.30 }
  };
}
  ...
  /**
   * SURGICAL ADDITION FOR BATCH PROCESSING
   * Processes an array of events by calling enhanceEvent for each one.
   * @param {Array<Object>} events - An array of event objects.
   * @returns {Promise<Array<Object>>} A promise that resolves to an array of enhanced events.
   */
  async enhanceEvents(events) {
    const enhanced = [];
    for (const event of events) {
      try {
        ...
        console.warn(`⚠️ Enhancement failed for event ${event.name} during batch process:`, error.message);
